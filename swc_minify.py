    ...
    def ensure_dependencies(self):
        ...
        if not swc_core.exists():
            ...
            if not self._install_swc():
                print("❌ Не удалось установить @swc/core. Попробуйте вручную: npm install --save-dev @swc/core")
                sys.exit(1)
